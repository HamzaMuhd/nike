...
const Footer = () => {
  return (
   <footer className="max-container">
    <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
      ...
      <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
        {footerLinks.map((section) => (
          <div key={section}>
            <h4 className="font-montserrat text-white text-2xl leading-normal font-medium mb-6">{section.title}</h4>
            <ul>
    ...
    <div className="flex justify-between mt-24 max-sm:items-center max-sm:flex-col text-white-400">
        <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
                ...
                <p className="font-monsterrat cursor-pointer">Terms & Condions</p>
        </div>
    </div>
   </footer>
  )
